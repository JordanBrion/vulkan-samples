...
fn main() {
    unsafe {
        ...
        let swapchain_images = swapchain_loader.get_swapchain_images(swapchain).expect("Cannot get swapchain images");
        ...
        let render_pass = logical_device
            ...
            let framebuffer = logical_device.create_framebuffer(&framebuffer_create_info, None);
